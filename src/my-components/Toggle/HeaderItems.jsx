...
class HeaderItems extends React.Component {
  ...
  failedEvents = () => this.props && !this.state.normalAlertOverride ? this.props.responseArray.find(e => e.status !== 200) : null;

  toggleDropdown = () => this.setState({dropdownShown: !this.state.dropdownShown, normalAlertOverride: true})
